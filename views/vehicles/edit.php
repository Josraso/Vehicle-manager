<?php $title = 'Editar Vehículo - Vehicle Manager'; ?>
    ...
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="index.php?action=vehicle_edit&id=<?= $vehicle['id'] ?>" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="btn-group w-100" role="group">
                            <input type="radio" class="btn-check" name="type" id="typeMoto" value="motorcycle"
                                   <?= $vehicle['type'] === 'motorcycle' ? 'checked' : '' ?>>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control" id="displacement" name="displacement"
                                   value="<?= htmlspecialchars($vehicle['displacement'] ?? '') ?>"
                                   min="0" max="10000">
                        </div>
                        <div class="col-md-4 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" id="current_km" name="current_km"
                                       value="<?= htmlspecialchars($vehicle['current_km']) ?>" min="0">
                            ...
                            <select class="form-select" id="default_fuel_type_id" name="default_fuel_type_id">
                                <?php foreach ($fuelTypes ?? [] as $type): ?>
                                    <option value="<?= $type['id'] ?>"
                                            <?= ($vehicle['default_fuel_type_id'] ?? 1) == $type['id'] ? 'selected' : '' ?>>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <?php if (!empty($vehicle['photo'])): ?>
                                <div class="mb-2">
                                    <img src="<?= htmlspecialchars($vehicle['photo']) ?>" alt="Foto actual" class="img-thumbnail" style="max-height: 80px;">
                                </div>
                            <?php endif; ?>
                            <input type="file" class="form-control" id="photo" name="photo"
                                   accept="image/jpeg,image/png,image/gif,image/webp">
                            <div class="form-text">Vacío = mantener actual</div>
                        </div>
                    </div>
